...
namespace OMP.API.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [AllowAnonymous]
        [Route("Register")]
        public async Task<IHttpActionResult> Register(UserProfileViewModel userProfileVM)
        {
            ...
            IdentityResult result = await authRepo.RegisterUser(userProfileVM);
        ...
        private async Task<ParsedExternalAccessToken> VerifyExternalAccessToken(string provider, string accessToken)
        {
            ...
            if (provider == "Facebook")
            {
                ...
                var appToken = "235302619851727|nzkalowDteBs8n4I_d-WA2zjgJA";
        ...
        public async Task<IHttpActionResult> ObtainLocalAccessToken(string provider, string externalAccessToken)
        {
            ...
            IdentityUser user = await authRepo.FindAsync(new UserLoginInfo(provider, verifiedAccessToken.user_id));
